...
class RoboclawNode(Node):
    ...
    def read_parameters(self):
        ...
        self.ADDRESS = self.init_parameter("address", 0x80)
        ...
        self.PUBLISH_ELEC = self.init_parameter("publish_elec", False)
        self.PUBLISH_TF = self.init_parameter("publish_tf", True)
